...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_COLEMAK] = LAYOUT(
		...
		KC_APP,  	KC_BSPC,   	KC_A,     	KC_R,     	KC_S,  		KC_T,  		KC_G,  		KC_M,    	KC_N,  		KC_E,    	KC_I,     	KC_O,     		KC_QUOT,  		KC_EQL,  					KC_HOME,
		KC_LGUI,  	KC_LSFT,   	KC_X,     	KC_C,     	KC_D,  		KC_V,  		KC_Z,  		KC_K,    	KC_H,  		KC_COMM, 	KC_DOT,   	KC_SLSH,  		RSFT_T(KC_BSLS),KC_UP,   					KC_END,
	...
	[_LOWER] = LAYOUT(
		_______, 	KC_TILD,	KC_EXLM, 	KC_AT,   	KC_HASH, 	KC_DLR,  KC_PERC, 		KC_CIRC, 	KC_AMPR,    KC_ASTR,    KC_LPRN, 	KC_RPRN, 		KC_LCBR,  		KC_RCBR, 		KC_UNDS,    _______,
	...
	[_RAISE] = LAYOUT(
		_______, 	KC_GRV,     KC_1,    	KC_2,    	KC_3,    	KC_4,    	KC_5,    	KC_6,    	KC_7,    	KC_8,    	KC_9,    	KC_0,    		_______,	    _______,  		_______, 	_______,
		_______,  	_______,   	_______,    _______,    _______,   _______,  	_______,  	_______,    KC_LEFT,  	KC_UP,      KC_DOWN,    KC_RIGHT,     	_______,  		_______,  					_______,
		_______,  	_______,   	_______,    _______,    _______,   _______,  	_______,  	_______,    _______,  	_______, 	_______,   	_______,  		_______,  		_______,   					_______,
		_______,  	_______,   				_______,  	_______,	       		_______,	_______, 				_______,              	     			_______,  		_______, 		_______
	),
	...
	[_ADJUST] = LAYOUT(
		_______, 	_______,   	KC_F1,    	KC_F2,    	KC_F3,   	KC_F4,  	KC_F5,  	KC_F6,    	KC_F7,  	KC_F8,    	KC_F9,    	KC_F10,	    	_______,  		_______, 		_______, 	QK_BOOT,
