...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[0] = LAYOUT( /* Base */
		    ...
		    KC_F2,  KC_CAPS,   KC_A,     KC_R,     KC_S,  KC_T,  KC_G,  KC_M,    KC_N,  KC_E,    KC_I,     KC_O,     KC_QUOT,  KC_ENT,  KC_HOME,
		    KC_F3,  KC_LSFT,   KC_X,     KC_C,     KC_D,  KC_V,  KC_Z,  KC_K,    KC_H,  KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,   KC_END,
		    KC_F4,  KC_LCTL,   KC_LALT,            KC_SPC,       KC_SPC,         KC_RALT, KC_RCTL,                   KC_LEFT,  KC_DOWN, KC_RIGHT),
 };
